...
if __name__ == '__main__':
    ...
    tau_alpha = [1]
    outdir_root = 'exp_v1_order_bug_agg_weight_sha_cat_splitter_sha_10'
    our_dir_name_prefix = 'exp_ls_epoch_alpha_tune_'
    yaml_file_name_prefix = 'alpha_tune_fedex_for_cifar10_'
    yaml_root_prefix = 'scripts/marketplace/example_scripts/ls_run_scripts_exp_v1_order_bug_agg_weight_sha_cat_splitter_sha_10/'
    ...
    sh_pth = 'scripts/marketplace/rep_sh_v1_order_bug_agg_weight_sha_cat_splitter_sha_10'
