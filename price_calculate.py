...
def price_calculation(influence_matrix_info,
                      client_bid,
                      price_tau,
                      state_idx=398):
    if state_idx not in influence_matrix_info.keys():
        ...
        print(
            'state_idx {} is not in influence_matrix_info.keys(), replace as {}'
            .format(tmp, state_idx))
...
info_matrix_pth = 'exp_consistent/exp_ls_epoch_alpha_tune_3_clients_1000_20_10_consistent_label_entropy_tau_alpha/FedAvg_convnet2_on_CIFAR10@torchvision_lr0.5_lstep2/3_clients_111_inf_matrix.pickle'
